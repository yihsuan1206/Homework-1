...
contract NFinTech is IERC721 {
    ...
    function approve(address to, uint256 tokenId) external {
        ...
        require(owner == msg.sender || _operatorApproval[owner][msg.sender], "No permission");
    ...
    function getApproved(uint256 tokenId) public view returns (address operator) {
        // TODO: please add your implementaiton here
        require(_owner[tokenId]!=address(0),"doesn't exist");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        require(_owner[tokenId] == from,"error");
        _tokenApproval[tokenId] = to;
        _balances[from] -= 1;
        _balances[to] += 1;
        _owner[tokenId] = to;
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId) public {
        ...
        require(IERC721TokenReceiver(address(to)).onERC721Received(from, to, tokenId, "") == IERC721TokenReceiver.onERC721Received.selector, "Error");
    }
}
